          ...
          <CardContent className="p-2 md:p-3">
            <div className="flex md:flex-col overflow-x-auto md:overflow-x-visible space-x-1 md:space-x-0 md:space-y-1 pb-2 md:pb-0">
              <Button
                ...
                className="shrink-0 md:w-full justify-start whitespace-nowrap"
              ...
              <Button
                variant="ghost"
                className="shrink-0 md:w-full justify-start text-red-600 hover:text-red-700 hover:bg-red-50 whitespace-nowrap"
